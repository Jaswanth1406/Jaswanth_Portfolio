...
const Certificates: React.FC = () => {
  ...
  const certificates: Certificate[] = [
    ...
    // --- Workshops ---
    { id: 11, name: "Games We Play", issuer: "IIT Madras", date: "2024", imageUrl: "/certificates/images/Games-We-Play.jpg", description: "Game theory and strategic decision making.", category: "workshop" },
